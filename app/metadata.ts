...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://aamirenterprises.com/og-home.jpg',
        width: 1200,
        height: 630,
        alt: 'Aamir Enterprises S Home Page',
      },
    ],
    locale: 'en_IN',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Aamir POP work Bhopal | POP Ceiling Bhopal | False Ceiling Contractor | Aamir POP works',
    description: 'Aamir POP work Bhopal - Best POP ceiling and false ceiling contractor in Bhopal, Madhya Pradesh. Expert POP work and false ceiling installation. Aamir POP works.',
    images: ['https://aamirenterprises.com/og-home.jpg'],
  },
  robots: {
    index: true,
    follow: true,
  ...
  alternates: {
    canonical: 'https://aamirenterprises.com',
  },
};
